# DLT_Bronze_Daily_Sales_Report

This folder defines all source code for the 'DLT_Bronze_Daily_Sales_Report' pipeline:
...
* Take a look at the sample under "sample_users_dlt_bronze_daily_sales_report.py" to get familiar with the syntax.
